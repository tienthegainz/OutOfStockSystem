...
from detect_engine.retinanet.utils import BasicBlock, Bottleneck, BBoxTransform, ClipBoxes
from detect_engine.retinanet.anchors import Anchors
from detect_engine.retinanet import losses
...
def retina_bb_resnet18(num_classes, pretrained=False, **kwargs):
...
def retina_bb_resnet34(num_classes, pretrained=False, **kwargs):
...
def retina_bb_resnet50(num_classes, pretrained=False, **kwargs):
...
def retina_bb_resnet101(num_classes, pretrained=False, **kwargs):
...
def retina_bb_resnet152(num_classes, pretrained=False, **kwargs):
